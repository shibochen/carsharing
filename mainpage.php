        ...
        <head>
            ...
            <style>
                ...
                .trip {
                    ...
                    margin-bottom: 10px;
                    padding: 10px;
                    background: linear-gradient(#ECE9E6, #3C81BD);
                }
            ...
            <div class="container" id="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div>
                            <button type="button" class="btn btn-lg btn-primary" data-target="#addtripModal" data-toggle="modal" style="margin-left:-12px;">
                          Add trips
                      </button>
                        </div>
                ...
                <div class="modal" id="addtripModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    &times;
                            ...
                            <div class="modal-footer">
                                <input class="btn btn-success" name="createTrip" type="submit" value="Create Trip">
