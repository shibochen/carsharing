...
$message .= "http://csrookie.thecompletewebhosting.com/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for your Car Sharing account', $message, 'From:'.'wzzjroyop@gmail.com')){
